...
echo "  ${BOLD}Update log:${RESET}      tail -f $INSTALL_DIR/data/update.log"
echo "  ${BOLD}Handmatig updaten:${RESET} bash $INSTALL_DIR/update.sh"
echo ""
echo "Auto-update: elke 5 minuten gecontroleerd via cron (GitHub → main)"
